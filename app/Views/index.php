      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>Welcome to BlogHub: Personal Blogging Hub, your space to share stories, ideas, and passions with the world. </p>
            <p>Whether you're new to writing or experienced, our platform makes blogging easy and enjoyable. We believe in the power of sharing your voice and connecting with readers. Our goal is to give you simple tools to create, customize, and share meaningful content.</p>
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="tab-pane fade active show" id="features-tab-1">
            <div class="row">
              ...
              <img src="<?= base_url('assets/img/working-1.jpg') ?>" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane fade" id="features-tab-2">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img src="<?= base_url('assets/img/working-2.jpg') ?>" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End Tab Content Item -->
          ...
          <div class="tab-pane fade" id="features-tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img src="<?= base_url('assets/img/working-3.jpg') ?>" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End Tab Content Item -->
          ...
          <div class="tab-pane fade" id="features-tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
              <img src="<?= base_url('assets/img/working-4.jpg') ?>" alt="" class="img-fluid">
              </div>
            </div>
          </div><!-- End Tab Content Item -->
