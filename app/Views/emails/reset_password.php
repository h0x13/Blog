...
<body>
    <div class="container">
        <div class="email-wrapper">
            ...
            <div class="warning">
                <strong>Note:</strong> This password reset link will expire in 1 hour. If you did not request a password reset, you can safely ignore this email.
            </div>

            <div class="footer">
                <p>If you're having trouble clicking the button, copy and paste this URL into your web browser:</p>
                <p style="word-break: break-all; color: #0d6efd;"><?= base_url('reset-password/' . $token) ?></p>
