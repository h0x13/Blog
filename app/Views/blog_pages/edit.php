        ...
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= base_url('blogs/manage') ?>" class="btn btn-secondary">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form action="<?= base_url("blogs/edit/{$blog['slug']}") ?>" method="post" enctype="multipart/form-data" >
                        <?= csrf_field() ?>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title" value="<?= $blog['title'] ?>" placeholder="Enter a descriptive title" required>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                <textarea id="blogContent" name="content"><?= $blog['content'] ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="thumbnail-preview-container mt-2">
                                    <img id="thumbnailPreview" class="thumbnail-preview" 
                                         src="<?= $blog['thumbnail'] ? base_url('blogs/thumbnail/' . $blog['thumbnail']) : '' ?>" 
                                         <?= $blog['thumbnail'] ? 'style="display: block;"' : '' ?>>
                                    <div class="remove-thumbnail" id="removeThumbnail" <?= $blog['thumbnail'] ? 'style="display: block;"' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="visibility-options">
                                        <div class="form-check form-check-inline mb-2">
                                            <input class="form-check-input" type="radio" name="visibility" id="privateRadioBtn" value="private" <?= ($blog['visibility'] === 'private')? 'checked' : '' ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="visibility" id="publicRadioBtn" value="public" <?= ($blog['visibility'] === 'public')? 'checked' : '' ?>>
                        ...
                        <div class="action-buttons d-flex justify-content-end border-top pt-3">
                            ...
                            <button type="button" id="deleteBtn" class="btn btn-danger me-2" data-bs-toggle="modal" data-bs-target="#deleteBlogModal">
...
<?php
    ...
    if ($blog['categories']) {
        foreach ($blog['categories'] as $catId) {
...
<script>
    $(document).ready(function() {
        ...
        const categories = <?= json_encode($selectedCategories) ?>;
